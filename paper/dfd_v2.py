...
def create_dfd():
    ...
    add_text(340, 155, "评分/生成/RAG请求", size=13, anchor="middle")
    
    # Response: LLM → 系统 (right side)
    arrow_line(410, 100, 410, 200)
    add_text(460, 155, "评分结果/内容/RAG回答", size=13, anchor="middle")
    ...
    tree.write("/Users/carol/workspace/interview-guide/paper/top_level_dfd_v2.svg",
